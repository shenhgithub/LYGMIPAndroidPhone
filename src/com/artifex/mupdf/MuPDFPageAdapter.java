...
public class MuPDFPageAdapter extends BaseAdapter
{
    ...
    {
        // parent在这里是全屏幕的长宽
        // LogUtil.i("MuPDFPageAdapter" , "position="+position+";parent.getWidth()="+parent.getWidth() +
        ...
        PointF pageSize = mPageSizes.get(position);// pdf中每页真实的长宽
        if (pageSize != null)
        {
            // We already know the page size. Set it up
            // immediately
            // LogUtil.i("hoperun", "pageSize="+pageSize.x + ";y="+pageSize.y);
        ...
        else
        {
            ...
            AsyncTask<Void, Void, PointF> sizingTask = new AsyncTask<Void, Void, PointF>()
            {
                ...
                {
                    return mCore.getPageSize(position); // 获取当前pdf的长宽
                }
