...
public class MuPDFCore
{
    ...
    public static native void drawPage(Bitmap bitmap, int pageW, int pageH, int patchX, int patchY, int patchW,
        int patchH);
    ...
    public void gotoPage2(int page)
    {
    ...
    public synchronized void drawPage(int page, Bitmap bitmap, int pageW, int pageH, int patchX, int patchY,
