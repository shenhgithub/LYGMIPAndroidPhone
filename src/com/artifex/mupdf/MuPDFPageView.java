...
public class MuPDFPageView extends PageView
{
    ...
    @Override
    protected void drawPage(Bitmap bm, int sizeX, int sizeY, int patchX, int patchY, int patchWidth, int patchHeight)
    {
    ...
    {
        LinkInfo[] infos = mCore.getPageLinks(mPageNumber);
        return infos;
    }
}
