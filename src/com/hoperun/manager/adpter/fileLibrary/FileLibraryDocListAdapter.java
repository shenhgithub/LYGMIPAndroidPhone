 ...
 */
public class FileLibraryDocListAdapter extends PMIPBaseAdapter
{
    /** 上下文 **/
     ...
     * @param list 列表数据
     */
    public FileLibraryDocListAdapter(Context context, MetaResponseBody list)
    {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        viewHold.mTvDes.setText((String)list.getBuzList().get(position).get("funcdes"));
        return convertView;
    }
