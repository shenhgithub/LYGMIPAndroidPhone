 ...
 */
public class XwzxSecondAdapter extends PMIPBaseAdapter
{
    /** 上下文 **/
    private Context                  context;
    
    /** 数据列表 **/
    private List<GetXwzxDocListInfo> docLists;
     ...
     * @param type 类型
     */
    public XwzxSecondAdapter(Context context, List<GetXwzxDocListInfo> list, String user, String type)
    {
        super();
     ...
     */
    public List<GetXwzxDocListInfo> getDocLists()
    {
        return docLists;
    }
     ...
     * @EditHistory：<修改内容><修改人>
     */
    public void setDocLists(List<GetXwzxDocListInfo> docLists)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            viewHold.mtypeTv = (TextView)convertView.findViewById(R.id.files_type);
            
            viewHold.mRlayout = (RelativeLayout)convertView.findViewById(R.id.file_doc_list_item_layout);
            viewHold.mDetailRL = (RelativeLayout)convertView.findViewById(R.id.file_detail);
            viewHold.mTvTime2 = (TextView)convertView.findViewById(R.id.files_item_time2);
        ...
        GetXwzxDocListInfo docinfo = docLists.get(position);
        
        String isRead = docinfo.getStringKeyValue(GetXwzxDocListInfo.newmark);
        ...
        viewHold.mTvName.setText(docinfo.getStringKeyValue(GetXwzxDocListInfo.name).trim());
        
        viewHold.mTvTime.setText("时间：" + docinfo.getStringKeyValue(GetXwzxDocListInfo.regdate).trim());
        viewHold.mTvTime2.setText("时间：" + docinfo.getStringKeyValue(GetXwzxDocListInfo.regdate).trim());
        String type = docinfo.getStringKeyValue(GetXwzxDocListInfo.typename).trim();
        if (null != type && !type.equals(""))
        {
            // viewHold.mtypeTv.setVisibility(View.VISIBLE);
            viewHold.mDetailRL.setVisibility(View.VISIBLE);
            viewHold.mTvTime2.setVisibility(View.GONE);
            viewHold.mtypeTv.setText("[" + docinfo.getStringKeyValue(GetXwzxDocListInfo.typename).trim() + "]");
        }
        else
        {
            viewHold.mDetailRL.setVisibility(View.GONE);
            viewHold.mTvTime2.setVisibility(View.VISIBLE);
            // viewHold.mtypeTv.setVisibility(View.GONE);
        }
