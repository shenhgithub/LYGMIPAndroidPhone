 ...
 */
public class HomeKanWuAdapter extends PMIPBaseAdapter
{
    /** 上下文 **/
     ...
     * @param mUnDo 已办/待办
     */
    public HomeKanWuAdapter(Context context, List<GetFileLibraryDocListInfo> list, String user)
    {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            viewHold.mFlag = (ImageView)convertView.findViewById(R.id.readFlag);
        ...
        viewHold.mName.setText(docinfo.getStringKeyValue(GetFileLibraryDocListInfo.title));
        if (docinfo.getStringKeyValue(GetLeaderPiShiListInfo.createdatetime).length() > 10)
        {
            viewHold.mDate.setText(docinfo.getStringKeyValue(GetFileLibraryDocListInfo.createdatetime).substring(0, 10));
        }
        else
        {
            viewHold.mDate.setText(docinfo.getStringKeyValue(GetFileLibraryDocListInfo.createdatetime));
        }
        
        String isRead = docinfo.getStringKeyValue(GetFileLibraryDocListInfo.l_read);
        if ("1".equals(isRead))
        {
            viewHold.mFlag.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.tag_read));
        }
        else
        {
            viewHold.mFlag.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.new_icon));
        }
        return convertView;
    }
