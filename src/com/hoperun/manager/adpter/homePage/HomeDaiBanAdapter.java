/*
 * File name:  HomeDaiBanAdapter.java
 ...
 */
public class HomeDaiBanAdapter extends PMIPBaseAdapter
{
    /** 上下文 **/
     ...
     * @param mUnDo 已办/待办
     */
    public HomeDaiBanAdapter(Context context, List<GetDocListInfo> list, String user)
    {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            convertView = inflater.inflate(R.layout.homepoplist_item, null);
        ...
        viewHold.mName.setText(docinfo.getStringKeyValue(GetDocListInfo.title));
        if (docinfo.getStringKeyValue(GetDocListInfo.createdatetime).length() > 10)
        {
            viewHold.mDate.setText(docinfo.getStringKeyValue(GetDocListInfo.createdatetime).substring(0, 10));
        }
        else
        {
            viewHold.mDate.setText(docinfo.getStringKeyValue(GetDocListInfo.createdatetime));
        }
        return convertView;
    }
