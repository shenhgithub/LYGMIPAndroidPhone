 ...
 */
public class CityPlanSecondAdapter extends PMIPBaseAdapter
{
    /** 上下文 **/
    private Context                context;
    
    /** 数据列表 **/
    private List<GetNettvListInfo> docLists;
     ...
     * @param mUnDo 已办/待办
     */
    public CityPlanSecondAdapter(Context context, List<GetNettvListInfo> list)
    {
        super();
    ...
    public List<GetNettvListInfo> getDocLists()
    {
        return docLists == null ? new ArrayList<GetNettvListInfo>() : docLists;
    }
    
    public void setDocLists(List<GetNettvListInfo> docLists)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        GetNettvListInfo docinfo = docLists.get(position);
        ...
        String isRead = docinfo.getStringKeyValue(GetNettvListInfo.l_read);
        ...
        viewHold.mTvName.setText(docinfo.getStringKeyValue(GetNettvListInfo.title));
        
        viewHold.mTvTime.setText(docinfo.getStringKeyValue(GetNettvListInfo.createdatetime));
