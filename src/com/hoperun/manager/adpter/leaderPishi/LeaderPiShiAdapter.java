 ...
 */
package com.hoperun.manager.adpter.leaderPishi;
 ...
 */
public class LeaderPiShiAdapter extends PMIPBaseAdapter
{
    /** 上下文 **/
     ...
     * @param mUnDo 已办/待办
     */
    public LeaderPiShiAdapter(Context context, List<GetLeaderPiShiListInfo> list, String user)
    {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            convertView = inflater.inflate(R.layout.leader_pishi_list_item, null);
        ...
        String isRead = docinfo.getStringKeyValue(GetLeaderPiShiListInfo.readstatus);
        ...
        viewHold.mTvName.setText(docinfo.getStringKeyValue(GetLeaderPiShiListInfo.title));
        
        viewHold.mTvTime.setText(docinfo.getStringKeyValue(GetLeaderPiShiListInfo.createdatetime));
