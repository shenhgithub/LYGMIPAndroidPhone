 ...
 */
package com.hoperun.manager.adpter.fastNews;
 ...
 */
public class FastNewsSecondAdapter extends PMIPBaseAdapter
{
    /** 上下文 **/
    private Context                   context;
    
    /** 数据列表 **/
    private List<GetFastNewsListInfo> docLists;
     ...
     * @param type 类型
     */
    public FastNewsSecondAdapter(Context context, List<GetFastNewsListInfo> list)
    {
        super();
     ...
     */
    public List<GetFastNewsListInfo> getDocLists()
    {
        return docLists;
    }
     ...
     * @EditHistory：<修改内容><修改人>
     */
    public void setDocLists(List<GetFastNewsListInfo> docLists)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        GetFastNewsListInfo docinfo = docLists.get(position);
        
        String isRead = docinfo.getStringKeyValue(GetXwzxDocListInfo.l_read);
        if ("1".equals(isRead))
        {
        ...
        viewHold.mTvName.setText(docinfo.getStringKeyValue(GetFastNewsListInfo.name));
        
        viewHold.mTvTime.setVisibility(View.GONE);
