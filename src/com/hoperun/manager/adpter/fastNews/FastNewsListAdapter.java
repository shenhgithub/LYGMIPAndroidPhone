 ...
 */
public class FastNewsListAdapter extends PMIPBaseAdapter
{
    /** 上下文 **/
     ...
     * @param list 列表数据
     */
    public FastNewsListAdapter(Context context, List<HashMap<String, Object>> list)
    {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            name = (String)list.get(position).get("funcname");
        }
