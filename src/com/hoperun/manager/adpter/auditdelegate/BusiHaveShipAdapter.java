 ...
 */
public class BusiHaveShipAdapter extends PMIPBaseAdapter
{
    /** 等待对话框 **/
     ...
     * @param list 列表数据
     */
    public BusiHaveShipAdapter(FragmentActivity context, List<HashMap<String, Object>> list, String status)
    {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            convertView = inflater.inflate(R.layout.busi_haveship_item, null);
            
            viewHold.text_1 = (TextView)convertView.findViewById(R.id.text_1);
            viewHold.text_2 = (TextView)convertView.findViewById(R.id.text_2);
        ...
        String shipname = (String)listmap.get(position).get("shipname");
        String voyage = (String)listmap.get(position).get("voyage");
        ...
        if (StringUtils.isNull(shipname))
        {
            shipname = "";
        }
        if (StringUtils.isNull(voyage))
        {
            voyage = "";
        }
        ...
        viewHold.text_1.setText(shipname);
        viewHold.text_2.setText(voyage);
