/*
 * File name:  DateTimePickerDialog.java
...
public class DateTimePickerDialog implements OnDateChangedListener, OnTimeChangedListener
{
    ...
    public AlertDialog dateTimePicKDialog(final TextView dateTimeText, int type, int id)
        ...
        switch (type)
        {
            ...
            default:
                LinearLayout dateTimeLayout =
                    (LinearLayout)activity.getLayoutInflater().inflate(R.layout.datetime, null);
                ...
                ad =
                    new AlertDialog.Builder(activity).setIcon(R.drawable.time_selected)
