/*
 * File name:  XwzxDetailListActivity.java
 ...
 */
public class XwzxDetailListActivity extends PMIPBaseActivity implements IFragmentToMainActivityListen, OnTouchListener
{
    ...
    public void initData()
    {
        ...
        Bundle bd = intent.getBundleExtra("module");
        
        String path2 = intent.getStringExtra("path");
        
        GWDocModule mModlue = (GWDocModule)bd.getSerializable("module");
        ...
        fragmentTransaction.replace(R.id.framge_1, mXwzxSecondFragment);
