/*
 * File name:  XwzxFirstFragment.java
 ...
 */
public class XwzxFirstFragment extends PMIPBaseSecondFragment implements OnItemClickListener, OnClickListener
{
    /** 应用上下文 **/
     ...
     */
    public static XwzxFirstFragment newInstance(String funcId, String funName, String parentsPath)
    {
        XwzxFirstFragment details = new XwzxFirstFragment();
