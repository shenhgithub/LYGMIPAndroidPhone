 ...
 */
package com.hoperun.project.ui.function.ygfw;
 ...
 */
public class YgfwFragment extends PMIPBaseSecondFragment implements OnItemClickListener, OnClickListener
{
    /** 员工服务一级栏目adpter **/
    ...
    public static YgfwFragment newInstance(String parentspath, String funcId, String funName)
    {
        YgfwFragment details = new YgfwFragment();
    ...
    private void getDocModuleList()
    {
        ...
        if (GlobalState.getInstance().getmYgfwFirstModule() != null
            && GlobalState.getInstance().getmYgfwFirstModule().getBuzList() != null
            && GlobalState.getInstance().getmYgfwFirstModule().getBuzList().size() != 0)
        {
            MetaResponseBody responseBuzBody = GlobalState.getInstance().getmYgfwFirstModule();
        ...
        if (offLine)
        {
            ...
            if (queryret != null && queryret.size() != 0)
            {
                ...
                GlobalState.getInstance().setmYgfwFirstModule(m);
            ...
            switch (requestType)
            {
                case RequestTypeConstants.GETDOCMODULELIST:
                    ...
                    if (objBody != null)
                    {
                        ...
                        GlobalState.getInstance().setmYgfwFirstModule(responseBuzBody);
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3)
    {
        ...
        // 云港书吧
        if (funcCode.equals("YGSB"))
        {
            packageName = "com.dooland.mobileforenterprise.reader";
        }
        // 云学堂
        else if (funcCode.equals("YXT"))
        {
            packageName = "com.oceansoft.elearning";
        }
        // 知识中心
        else if (funcCode.equals("ZSZX"))
        {
            packageName = "";
        }
        // iService
        else if (funcCode.equals("IS"))
        {
            packageName = "";
        }
