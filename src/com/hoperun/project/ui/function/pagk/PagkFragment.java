 ...
 */
package com.hoperun.project.ui.function.pagk;
 ...
 */
public class PagkFragment extends PMIPBaseSecondFragment implements OnItemClickListener, OnClickListener
{
    /** 平安港口一级栏目adpter **/
    ...
    public static PagkFragment newInstance(String parentspath, String funcId, String funName)
    {
        PagkFragment details = new PagkFragment();
    ...
    private void getDocModuleList()
    {
        ...
        if (GlobalState.getInstance().getmPagkFirstModule() != null
            && GlobalState.getInstance().getmPagkFirstModule().getBuzList() != null
            && GlobalState.getInstance().getmPagkFirstModule().getBuzList().size() != 0)
        {
            MetaResponseBody responseBuzBody = GlobalState.getInstance().getmPagkFirstModule();
        ...
        if (offLine)
        {
            ...
            if (queryret != null && queryret.size() != 0)
            {
                ...
                GlobalState.getInstance().setmPagkFirstModule(m);
            ...
            switch (requestType)
            {
                case RequestTypeConstants.GETDOCMODULELIST:
                    ...
                    if (objBody != null)
                    {
                        ...
                        GlobalState.getInstance().setmPagkFirstModule(responseBuzBody);
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3)
    {
        ...
        // 安全监管
        if (funcCode.equals(ConstState.SPJK_AQJG))
        {
            packageName = "com.shouan.iliad.lyg";
        }
        // 平安港口
        else if (funcCode.equals(ConstState.SPJK_PAGK))
        {
            packageName = "com.ivms.hik5060v32";// com.mcu.iVMS
        }
