 ...
 */
public class LowcPortFragment extends PMIPBaseSecondFragment implements OnItemClickListener, OnClickListener
{
    /** 设备运行 一级栏目adpter **/
    ...
    public static LowcPortFragment newInstance(String parentspath, String funcId, String funName)
    {
        LowcPortFragment details = new LowcPortFragment();
                ...
                case RequestTypeConstants.GETDOCMODULELIST:
                    ...
                    if (responseBuzBody != null && responseBuzBody.getRetError().equals("0"))
                    {
                        ...
                        if (!ret.get(0).get("webitems").equals(""))
                        {
                            ...
                            GlobalState.getInstance().setmLowcPortModule(resultList);
    ...
    private void getDocModuleList()
    {
        ...
        if (GlobalState.getInstance().getmLowcPortModule() != null
            && GlobalState.getInstance().getmLowcPortModule().size() > 0)
        {
            List<HashMap<String, Object>> wetitem = GlobalState.getInstance().getmLowcPortModule();
        ...
        if (offLine)
        {
            ...
            {
                GlobalState.getInstance().setmLowcPortModule(queryret);
    ...
    private void itemtClickOne(HashMap<String, String> item)
    {
        ...
        {
            Intent intent = new Intent(mActivity, LowcPortShowActivity.class);
