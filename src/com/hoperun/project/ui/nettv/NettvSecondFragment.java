 ...
 */
public class NettvSecondFragment extends PMIPCustomFragment
{
    /** activity **/
    ...
    private NettvListView      nettvView      = null;
    
    /**
     * 搜索 listview
     */
    private NettvListView      mSearchView    = null;
     ...
     */
    public static NettvSecondFragment newInstance(String type, String searchStr, String parentPath, String funName,
        String funcid)
    {
        NettvSecondFragment details = new NettvSecondFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        nettvView = (NettvListView)initOfficalListView(nettvView, "", "");
    ...
    public void onResume()
    {
        ...
        filter.addAction(NettvSecondFragment.docSendSuccess);
    ...
    public Object initOfficalListView(Object view, String keyWords, String typeId)
    {
        ...
        {
            view =
                new NettvListView(mActivity, keyWords, "", "", "", CreateDirPath(getParentPath()),
                    mViewLandscapeSlideListener, false, funcId);
            ((NettvListView)view).setResultListen(mResultlisten);
        }
        return view;
    }
    ...
    {
        mSearchView = null;
        mSearchView = (NettvListView)initOfficalListView(mSearchView, keyWords, typeId);
